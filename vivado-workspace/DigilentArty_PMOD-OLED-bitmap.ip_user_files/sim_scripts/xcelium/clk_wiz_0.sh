...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../../DigilentArty_PMOD-OLED-bitmap.gen/sources_1/ip/clk_wiz_0" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../../DigilentArty_PMOD-OLED-bitmap.gen/sources_1/ip/clk_wiz_0" \
