...
#
# Script generated by Vivado on Mon Jun 23 00:51:20 AEST 2025
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname blk_mem_gen_v8_4_11 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib blk_mem_gen_v8_4_11)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "tb_top.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  xmvlog -work blk_mem_gen_v8_4_11 $xmvlog_opts +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../ipstatic" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/grey/Documents/2025/software"
  fi
