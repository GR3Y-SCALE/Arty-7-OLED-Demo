...
architecture rtl of fpga_top is
    ...
    type OledBitmapArray		is array (0 to 54) of r_OLED_ARRAY;
    
    --(0,0) =>      APPLE
    --(0,1) => GPU Internship
    --(0,2) => Made 2025:06:22
    --(0,3) => By Maurice Blake
 
    constant OledArray : OledBitmapArray := ( 	( 0,0,X"20"),( 1,0,X"20"),( 2,0,X"20"),( 3,0,X"20"),( 4,0,X"20"),( 5,0,X"41"),( 6,0,X"50"),( 7,0,X"50"),( 8,0,X"4C"),( 9,0,X"45"),
                                                    ...
                                                    ( 0,2,X"4D"),( 1,2,X"61"),( 2,2,X"64"),( 3,2,X"64"),( 4,2,X"20"),( 5,2,X"32"),( 6,2,X"30"),( 7,2,X"32"),( 8,2,X"35"),( 9,2,X"3A"),( 10,2,X"30"),( 11,2,X"36"),( 12,2,X"3A"),( 13,2,X"32"),( 14,2,X"32"),

                                                    ( 0,3,X"42"),( 1,3,X"79"),( 2,3,X"20"),( 3,3,X"4D"),( 4,3,X"61"),( 5,3,X"75"),( 6,3,X"72"),( 7,3,X"6C"),( 8,3,X"63"),( 9,3,X"65"),( 10,3,X"20"),( 11,3,X"42"),( 12,3,X"6C"),( 13,3,X"61"),( 14,3,X"6B"),( 15,3,X"65")
                                                );
...
PM_CLKDIV_1M: entity work.clkdiv_1MHz
    generic map (
        PRESCALER 			=> 100
    )	
    port map ( 	
...
PM_CLKDIV_1K: entity work.clkdiv_1kHz
    generic map (
        PRESCALER 			=> 100  
    )	
    port map ( 	
