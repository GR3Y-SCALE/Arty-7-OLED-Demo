...
design_libs=(xpm xil_defaultlib blk_mem_gen_v8_4_11)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../ipstatic" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../ipstatic" \
  "../../../../../software\\ projects/DigilentArty_PMOD-OLED-bitmap/DigilentArty_PMOD-OLED-bitmap.srcs/sources_1/new/tb_top.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
  ...
  vlogan -work blk_mem_gen_v8_4_11 $vlogan_opts +v2k +incdir+"../../../../../../Xilinx-Vivado/2025.1/data/rsb/busdef" +incdir+"../../ipstatic" \
